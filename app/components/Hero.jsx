  ...
  return (
    <section className="relative overflow-hidden px-6 py-14">
      ...
      <div className="mx-auto max-w-7xl container grid lg:grid-cols-2 gap-16">
        ...
        >
          <div className="mb-6 flex items-center gap-2 w-fit rounded-full border border-orange-100 bg-orange-50/50 px-4 py-1.5 text-xs font-bold uppercase tracking-widest text-orange-700">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4">
            <button className="group relative overflow-hidden rounded-full bg-slate-900 px-8 py-4 font-bold text-white transition-all hover:bg-orange-600">
            ...
            <button className="flex items-center justify-center gap-2 rounded-full border-2 border-slate-200 px-8 py-4 font-bold text-slate-700 transition-all hover:border-slate-900 hover:bg-slate-50">
